...
jQuery(document).ready(function () {
  ...
  function waxon_tm_about_animations() {
    ...
    new swiper__WEBPACK_IMPORTED_MODULE_3__.default(image, {
      delay: 5,
      overflow: true,
      orientation: 'down'
    });
    var image2 = document.getElementsByClassName('thumbnail-2');
    new swiper__WEBPACK_IMPORTED_MODULE_3__.default(image2, {
      delay: 5,
      overflow: true,
      orientation: 'right'
    });
    var image3 = document.getElementsByClassName('thumbnail-3');
    new swiper__WEBPACK_IMPORTED_MODULE_3__.default(image3, {
      delay: 5
    });
    var image4 = document.getElementsByClassName('thumbnail-4');
    new swiper__WEBPACK_IMPORTED_MODULE_3__.default(image4, {
      delay: 5,
      orientation: 'right'
    });
  }
  ...
  new (wowjs__WEBPACK_IMPORTED_MODULE_2___default().WOW)({
    live: false
  }).init(); // -----------------------------------------------------
  // -----------------   SWIPER SLIDER    ----------------
  // -----------------------------------------------------
  ...
  function waxon_tm_imgtosvg() {
    jQuery('img.svg').each(function () {
      ...
      jQuery.get(imgURL, function (data) {
        ...
        var jQuerysvg = jQuery(data).find('svg'); // Add replaced image's classes to the new SVG
        ...
        jQuerysvg = jQuerysvg.removeAttr('xmlns:a'); // Replace image with new SVG
